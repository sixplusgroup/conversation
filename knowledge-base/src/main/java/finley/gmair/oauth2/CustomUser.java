...
public class CustomUser implements UserDetails, CredentialsContainer{
    ...
    public CustomUser(String username, String password,String type,Integer id, Collection<? extends GrantedAuthority> authorities) {
        this(username, password, type,id,true, true, true, true, authorities);
    }

    public CustomUser(String username, String password, String type,Integer id,boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities) {
    ...
    public boolean equals(Object rhs) {
        return rhs instanceof CustomUser ? this.username.equals(((CustomUser)rhs).username) : false;
    }
    ...
    public static CustomUser.UserBuilder withDefaultPasswordEncoder() {
        ...
        CustomUser.UserBuilder var10000 = builder();
        encoder.getClass();
    ...
    public static class UserBuilder {
        ...
        public UserDetails build() {
            ...
            return new CustomUser(this.username, encodedPassword,this.type,this.id,!this.disabled, !this.accountExpired, !this.credentialsExpired, !this.accountLocked, this.authorities);
        }
    }
