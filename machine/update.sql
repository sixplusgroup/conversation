...
delete from mc where qr_code in
(select * from machine_filter_clean mc,qrcode qr,goods_model gm
where mc.qr_code=qr.code_value and qr.model_id=gm.model_id and gm.goods_id <> 'GUO20180607ggxi8a96');
