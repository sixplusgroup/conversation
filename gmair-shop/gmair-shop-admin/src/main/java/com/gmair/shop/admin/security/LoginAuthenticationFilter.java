...
import com.gmair.shop.security.exception.BadCredentialsExceptionBase;
import com.gmair.shop.security.exception.ImageCodeNotMatchExceptionBase;
...
public class LoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private GmairUserDetailsService gmairUserDetailsService;
...
//        }
        ...
        UserDetails user;
        try {
            user = gmairUserDetailsService.loadUserByUsername(username);
