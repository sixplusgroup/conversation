...
import com.gmair.shop.bean.app.dto.UserAddrDto;
import com.gmair.shop.bean.app.param.AddrParam;
...
//        return new ResponseEntity<>(mapperFacade.mapAsList(userAddrs, UserAddrDto.class),headers,HttpStatus.OK);
        // 2
//        return new ResponseEntity<List<UserAddrDto>>(mapperFacade.mapAsList(userAddrs, UserAddrDto.class),HttpStatus.OK);
        ResponseEntity<List<UserAddrDto>> result = ResponseEntity.ok(mapperFacade.mapAsList(userAddrs, UserAddrDto.class));
        return result;
