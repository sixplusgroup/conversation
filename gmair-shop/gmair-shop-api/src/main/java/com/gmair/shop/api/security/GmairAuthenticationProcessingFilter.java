 ...
 *
 */
public class GmairAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    protected GmairAuthenticationProcessingFilter(String defaultFilterProcessesUrl) {
