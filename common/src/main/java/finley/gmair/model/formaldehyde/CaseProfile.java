...
public class CaseProfile extends Entity {
    ...
    public CaseProfile(String caseHolder, String equipmentId, String checkDuration, Timestamp checkDate, String caseCityId, String caseCityName, String caseLocation, String checkTrace, CaseStatus caseStatus, String videoId) {
        super();
