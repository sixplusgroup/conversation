...
public class TmallUpdateServiceImpl implements TmallUpdateService {
    ...
    private static final String appKey = "30478551";
    private static final String appSecret = "be8812c7d6e6fbb2202e1fc0fd182a6b";
     ...
     */
    @Override
    public void updateListNotify(String accessToken) throws IOException {
        /*
